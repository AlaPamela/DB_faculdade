CREATE DATABASE  IF NOT EXISTS `universidade_senai` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `universidade_senai`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: universidade_senai
-- ------------------------------------------------------
...
-- Dump completed on 2022-06-09 16:43:28
